...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl", 'tvsum',"charadesSTA","qvhighlight","tacos"])
        ...
        # subtitles
        parser.add_argument("--s_feat_dir", help="subtitle feature dir")
        parser.add_argument("--s_feat_dirs", help="subtitle feature dir",nargs="+")
        parser.add_argument("--s_feat_dim",type=int,  help="subtitles feature dim")
        parser.add_argument("--s_feat_type", help="subtitles feature type",default="clip")
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['fsdo/model.py',
                        'fsdo/transformer.py',
                        'fsdo/train.py',
                        'fsdo/start_end_dataset_subtitles.py']
